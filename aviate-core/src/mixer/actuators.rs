//! Actuator, group, and mode configuration types the mixers and
//! sanitizer speak in: channel identities, group coupling and
//! fallback policy, command/state vectors, and their defaults.
