...
IMPL_MAP=(
    ...
    'controller|controller.multirotor.v3|MultirotorController|aviate-core/src/control/multirotor.rs'
...
OWNERSHIP=(
    ...
    'aviate-core/src/control/multirotor.rs|controller/controller.multirotor.v3'
    'aviate-core/src/control/multirotor/|controller/controller.multirotor.v3'
    'aviate-core/src/control/observation.rs|controller/controller.multirotor.v3'
    'aviate-core/src/control/transfer.rs|controller/controller.multirotor.v3'
    'aviate-core/src/control/vehicle_control_mode.rs|controller/controller.multirotor.v3'
    'aviate-core/src/control/rate.rs|controller/controller.multirotor.v3'
    'aviate-core/src/control/velocity.rs|controller/controller.multirotor.v3'
    ...
    'aviate-core/src/control.rs|controller/controller.multirotor.v3,controller/controller.fixed_wing.v1,controller/controller.vtol.v1'
    'aviate-core/src/control/|controller/controller.multirotor.v3,controller/controller.fixed_wing.v1,controller/controller.vtol.v1'
...
GENERIC_QUAD_BUNDLE='ekf.basic-15state.v3 controller.multirotor.v3 mixer.quad_x.v2 sanitizer.group_aware.v1'
GENERIC_QUAD_AGGREGATE='1348d978104bc3b1'
X500_BUNDLE='ekf.basic-15state.v3 controller.multirotor.v3 mixer.quad_x_x500.v2 sanitizer.group_aware.v1'
X500_AGGREGATE='330bce1c32c9e2b8'
...
self_test() {
    ...
    local folded
    folded="$(fnv_fold 4554494d454b4634 43544c4d55525633 4d49585155414432 53414e4752505631)"
    ...
    expect_msg fail 'attitude.rs (unrotated: .*controller/controller.multirotor.v3' \
