...
fn generate_memory_x(
    ...
    if family == ChipFamily::Rp2350 {
        ...
        // Emit the FLASH length in exact bytes so the region ends
        // precisely at the application boundary. Kibibyte-rounded
        // lengths would truncate below the boundary and leave the
        // exported region-end symbol short of `APP_START`.
        format!(
